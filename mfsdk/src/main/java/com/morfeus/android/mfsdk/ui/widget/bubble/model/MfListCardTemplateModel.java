...
public final class MfListCardTemplateModel extends TemplateModel {
    private List<MfListContentData> mfListContentDatas;

    public MfListCardTemplateModel(@NonNull String templateId, @NonNull MFCardData MFCardData) {
    ...
    private MfListContentData deserializeMsgDataCardContentsElement(JsonObject contentJsonObject) {
        ...
        if (elementJsonObject.has(MsgParser.KEY_DESCRIPTION)) {
            JsonObject desElementJsonObject = elementJsonObject.getAsJsonObject(MsgParser.KEY_DESCRIPTION);
            MfElementData mfElementData = deserializeElement(MsgParser.KEY_DESCRIPTION, desElementJsonObject);
            MfComponentData mfComponentData = new MfComponentData(mfElementData);
            mfCardsList.add(mfComponentData);
        }
