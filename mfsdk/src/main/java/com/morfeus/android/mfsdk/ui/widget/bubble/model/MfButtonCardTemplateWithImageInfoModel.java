...
public class MfButtonCardTemplateWithImageInfoModel extends TemplateModel {
    private List<MfListContentData> mfListContentDatas;

    public MfButtonCardTemplateWithImageInfoModel(@NonNull String templateId, @NonNull MFCardData MFCardData) {
