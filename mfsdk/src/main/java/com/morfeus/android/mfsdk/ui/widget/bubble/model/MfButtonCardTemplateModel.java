...
public class MfButtonCardTemplateModel extends TemplateModel implements Comparable<MfButtonCardTemplateModel> {

    private List<MfComponentData> componentDatas;

    public MfButtonCardTemplateModel(@NonNull String templateId, @NonNull MFCardData MFCardData) {
    ...
    @Override
    public int compareTo(MfButtonCardTemplateModel mfButtonCardTemplateModel) {
        ...
        List<MfComponentData> compareObjComponentDatas = mfButtonCardTemplateModel.getComponentDatas();
