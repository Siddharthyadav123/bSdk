...
public class MfButtonCardTemplateWithStatusInfoModel extends TemplateModel {
    private List<MfListContentData> mfListContentDatas;

    public MfButtonCardTemplateWithStatusInfoModel(@NonNull String templateId, @NonNull MFCardData MFCardData) {
