package com.morfeus.android.mfsdk.ui.widget.audio;
...
public class WaveformView extends View {
    ...
    private static final float MIN_AMPLITUDE = 0f;
    private float mPrimaryWidth = 1.0f;
    private float mSecondaryWidth = 0.5f;
    private float mAmplitude = MIN_AMPLITUDE;
    private int mWaveColor = getResources().getColor(R.color.axisThemeColor);
