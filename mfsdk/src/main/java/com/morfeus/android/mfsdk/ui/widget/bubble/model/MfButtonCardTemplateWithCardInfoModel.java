...
public class MfButtonCardTemplateWithCardInfoModel extends TemplateModel {
    private List<MfListContentData> mfListContentDatas;

    public MfButtonCardTemplateWithCardInfoModel(@NonNull String templateId, @NonNull MFCardData MFCardData) {
